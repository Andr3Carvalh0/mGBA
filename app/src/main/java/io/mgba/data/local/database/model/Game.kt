package io.mgba.data.local.database.model
...
import io.mgba.main.adapters.TabViewPager.Companion.PLATFORM_GBA
import io.mgba.widgets.RecyclerViewItem

@Entity(tableName = "Games")
class Game : Parcelable, SearchSuggestion, RecyclerViewItem {
    ...
    override fun getLetterForItem(position: Int): String {
        getName()?.let {
            return it.substring(0, 1).toUpperCase()
        }
        return "?"
    }
