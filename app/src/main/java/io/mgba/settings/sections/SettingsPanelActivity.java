...
import io.mgba.settings.categories.SettingsCategoriesViewModel;
import io.mgba.ui.activities.SettingsPanelActivityPermissionsDispatcher;
...
public class SettingsPanelActivity extends AppCompatActivity implements ISettings, ISettingsPanelView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String id = savedInstanceState == null
                ? Objects.requireNonNull(getIntent().getExtras()).getString(SettingsCategoriesViewModel.Companion.getARG_SETTINGS_ID())
                : savedInstanceState.getString(SettingsCategoriesViewModel.Companion.getARG_SETTINGS_ID());
