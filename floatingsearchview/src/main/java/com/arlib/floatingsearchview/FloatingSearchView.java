...
public class FloatingSearchView extends FrameLayout {
    ...
    private void applyXmlAttributes(AttributeSet attrs) {
        ...
        try {
            mSearchTitleSize = a.getDimensionPixelSize(R.styleable.FloatingSearchView_floatingSearch_searchBarWidth, getResources().getDimensionPixelSize(R.dimen.text_size));
    ...
    private void setupQueryBar() {
        ...
        mSearchInput.setTextSize(TypedValue.COMPLEX_UNIT_PX, mSearchTitleSize);
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.textSize = mSearchTitleSize;
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        mSearchTitleSize = savedState.textSize;
