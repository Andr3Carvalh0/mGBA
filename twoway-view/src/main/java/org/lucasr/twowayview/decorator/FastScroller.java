...
import org.lucasr.twowayview.listeners.FastScrollStateChangeListener;
...
public class FastScroller extends LinearLayout {
    ...
    public void setLayoutParams(@NonNull ViewGroup viewGroup) {
        ...
        int marginTop = getResources().getDimensionPixelSize(R.dimen.twowayview_scrollbar_margin_top);
        int marginBottom = getResources().getDimensionPixelSize(R.dimen.twowayview_scrollbar_margin_bottom);
    ...
    private void showScrollbar() {
        if (mRecyclerView.computeVerticalScrollRange() - mViewHeight > 0) {
            float transX = getResources().getDimensionPixelSize(R.dimen.twowayview_scrollbar_padding_end);
    ...
    private void layout(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.twowayview_TwoWayView, 0, 0);

            if (typedArray != null) {
                try {
                    bubbleColor = typedArray.getColor(R.styleable.twowayview_TwoWayView_twowayview_bubbleColor, bubbleColor);
                    handleColor = typedArray.getColor(R.styleable.twowayview_TwoWayView_twowayview_handleColor, handleColor);
                    trackColor = typedArray.getColor(R.styleable.twowayview_TwoWayView_twowayview_trackColor, trackColor);
                    textColor = typedArray.getColor(R.styleable.twowayview_TwoWayView_twowayview_bubbleTextColor, textColor);
                    hideScrollbar = typedArray.getBoolean(R.styleable.twowayview_TwoWayView_twowayview_hideScrollbar, hideScrollbar);
                    showBubble = typedArray.getBoolean(R.styleable.twowayview_TwoWayView_twowayview_showBubble, showBubble);
                    showTrack = typedArray.getBoolean(R.styleable.twowayview_TwoWayView_twowayview_showTrack, showTrack);
                } finally {
                    typedArray.recycle();
                }
            }
