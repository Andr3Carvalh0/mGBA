...
package org.lucasr.twowayview.manager;
...
public class SpannableGridLayoutManager extends GridLayoutManager {
    ...
    protected static class SpannableItemEntry extends ItemEntry {
        ...
        SpannableItemEntry(int startLane, int anchorLane, int colSpan, int rowSpan) {
            super(startLane, anchorLane);
            this.colSpan = colSpan;
            this.rowSpan = rowSpan;
        }

        SpannableItemEntry(Parcel in) {
            super(in);
    ...
    public static class LayoutParams extends RecyclerView.LayoutParams {
        ...
        LayoutParams(MarginLayoutParams other) {
            super(other);
            init(other);
        }
